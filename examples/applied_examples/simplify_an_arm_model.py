...
def create_planar_model(
    ...
    # from biobuddy import MergeMusclesTool, MuscleMerge
    # merge_tool = MergeMusclesTool(model)
    # merge_tool.add(MuscleMerge(name="new_muscle_name", muscle_names=["first_fascicle", "second_fascicle"]))
