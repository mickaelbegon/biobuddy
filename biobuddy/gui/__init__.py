...
from .full_body_model202_template import (
    ...
    model202_virtual_marker_reference_map,
...
__all__ = [
    ...
    C3dModelCreationVariantResults.__name__,
    C3dModelPreset.__name__,
    C3dPresetVirtualFeature.__name__,
    c3d_model_preset_virtual_features.__name__,
    c3d_model_preset_from_cli_value.__name__,
    create_lower_limb_model_variants_from_c3d_folder.__name__,
    create_lower_limb_model_variants_from_marker_data.__name__,
    create_model_from_c3d_folder.__name__,
    create_model_from_marker_data.__name__,
    default_static_virtual_points_for_c3d_model_preset.__name__,
    ...
    c3d_virtual_marker_method_examples.__name__,
    c3d_workflow_draft.__name__,
    c3d_workflow_progress.__name__,
    c3d_workflow_summary.__name__,
    four_marker_groups.__name__,
    marker_names_from_c3d_file.__name__,
    parse_score_report.__name__,
    remove_axis_from_draft.__name__,
    clear_c3d_file_role_from_draft.__name__,
    remove_segment_from_draft.__name__,
    remove_virtual_marker_from_draft.__name__,
    score_virtual_marker_names_from_entry.__name__,
    ...
    model202_inertia_by_segment.__name__,
    model202_marker_attachments.__name__,
    model202_marker_names.__name__,
    model202_segment_specs.__name__,
    model202_unresolved_marker_references.__name__,
    model202_virtual_marker_reference_map.__name__,
    full_body_model202_functional_c3d_filenames.__name__,
    full_body_model202_functional_trials.__name__,
    full_body_model202_template.__name__,
