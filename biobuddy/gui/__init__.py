...
from .full_body_bela_template import (
    ...
    bela_virtual_marker_reference_map,
...
__all__ = [
    ...
    bela_virtual_marker_reference_map.__name__,
    full_body_bela_functional_c3d_filenames.__name__,
    full_body_bela_functional_trials.__name__,
    full_body_bela_template.__name__,
