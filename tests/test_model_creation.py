...
def test_model_creation_from_static_lower_body(align_scs):
    ...
    # Test that the markers and CoM are at the same place in the global reference frame
...
def test_create_rt_from_functional_trials():
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                [-0.248616, 0.96257873, 0.10785305, 0.61266775],
                [-0.96657715, -0.25374976, 0.03660143, 0.39369614],
                [0.06259944, -0.09514859, 0.99349286, 0.46687377],
                [0.0, 0.0, 0.0, 1.0],
            ]
        ),
        decimal=5,
